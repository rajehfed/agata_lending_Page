...
export default function TestimonialCard() {
  return (
    <div className="bg-[#111] w-11/12 p-10 rounded-box space-y-4">
      <h1 className="font-roboto-slab text-white text-4xl">
        Finding the right loan should be simple, <br />
        transparent, and personalized.
      </h1>
      <p className="parag">
        Here{"'"}s why Agata can help providing our users with the most <br />
        advenced and personalized loan advisory services avaible.
      </p>
      <div className="grid grid-cols-7 grid-rows-6 gap-3">
        <div className="row-start-1 row-end-5 col-start-1 col-end-5 rounded-xl flex justify-center items-center p-3 bg-primery-color">
          <div className="space-y-3">
            <h1 className="font-rubic text-2xl font-bold ">
              Made By Experts <br />
              In Lending Indestry
            </h1>
            <p className="parag">
              Our knowledgeable financial team with <br />
              years of experience in loans provides <br />
              accurate and reliable loan <br />
              recommendations.
            </p>
            <a className="mt-3 flex gap-4 items-center justify-start" href="#">
              LEARN MORE
              <span>
                <ArrowIcon />
              </span>
        ...
        <div className="col-start-5 col-end-8 rounded-xl bg-primery-color">
          hh
        </div>

        <div className="row-start-5 row-end-7 col-start-1 col-end-5 rounded-xl bg-primery-color"></div>

        <div className="row-start-2 row-end-7 col-start-5 col-end-8 rounded-xl bg-primery-color"></div>
      </div>
    </div>
  );
}
